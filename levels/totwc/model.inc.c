Vtx totwc_dl_Cube_mesh_layer_1_vtx_cull[8] = {
...
Vtx totwc_dl_Cube_mesh_layer_1_vtx_0[24] = {
...
Gfx totwc_dl_Cube_mesh_layer_1[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(totwc_dl_Cube_mesh_layer_1_vtx_cull + 0, 8, 0),
	...
	gsSPVertex(totwc_dl_Cube_mesh_layer_1_vtx_0 + 0, 24, 0),

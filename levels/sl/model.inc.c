Vtx sl_dl_Cube_mesh_layer_1_vtx_cull[8] = {
...
Vtx sl_dl_Cube_mesh_layer_1_vtx_0[24] = {
...
Gfx sl_dl_Cube_mesh_layer_1[] = {
	...
	gsSPVertex(sl_dl_Cube_mesh_layer_1_vtx_cull + 0, 8, 0),
	...
	gsSPVertex(sl_dl_Cube_mesh_layer_1_vtx_0 + 0, 24, 0),

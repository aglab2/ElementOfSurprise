Vtx bbh_dl_Cube_mesh_layer_1_vtx_cull[8] = {
...
Vtx bbh_dl_Cube_mesh_layer_1_vtx_0[24] = {
...
Gfx bbh_dl_Cube_mesh_layer_1[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(bbh_dl_Cube_mesh_layer_1_vtx_cull + 0, 8, 0),
	...
	gsSPVertex(bbh_dl_Cube_mesh_layer_1_vtx_0 + 0, 24, 0),

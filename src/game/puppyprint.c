...
void puppyprint_calculate_ram_usage_static(void) {
    ...
    ramsizeSegment[RAM_FRAMEBUFFERS] = ((u32)&_framebuffer0SegmentBssEnd - (u32)&_framebuffer0SegmentBssStart)
                                     + ((u32)&_framebuffer1SegmentBssEnd - (u32)&_framebuffer1SegmentBssStart)
